  ...
  return (
    <>
      ...
      <Modal
        ...
        onCancel={onClose}
      >
        {/* saeson mod: this updater pulls the OFFICIAL upstream build and would
            overwrite this fork - warn loudly and identify the mod version */}
        <Alert
          type="error"
          className="mb-12"
          title="saeson mod: 此更新来自官方 MHSanaei/3x-ui 仓库，升级会覆盖本修改版！升级 mod 请使用 saeson 仓库的 install.sh"
          showIcon
        />
